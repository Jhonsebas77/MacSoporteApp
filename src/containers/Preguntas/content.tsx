...
export default class Preguntas extends Component<ItemProps, ItemState> {
    constructor(props) {
        super(props)
    }
    ...
    render() {
        return (
            <ScrollView>
                <ImageBackground source={require('../../Assets/images/bn_Soporte.jpg')} style={styles.banner} >
                ...
                <View>
                    <Text>"Asesoramiento & Entrenamientos"</Text>
                    <Text>
